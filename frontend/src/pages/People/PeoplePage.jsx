...
import { Search, UserPlus, MessageSquare, BellOff, MoreVertical, X, Check, UserCheck, UserX, Globe, MapPin, Gamepad, Music, Code, Heart, Star, Users, Sparkles, Filter, Moon, Sun, Loader2, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-gradient-to-br from-purple-950 via-indigo-950 to-violet-950' : 'bg-gradient-to-br from-purple-100 via-pink-50 to-indigo-100'}`}>
      ...
      <button
        ...
        className={`fixed top-6 right-6 z-40 p-3 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 ${
              ...
              <div className="flex gap-1 p-2">
                ...
                >
                  ...
                  {friendRequests.length > 0 && (
                    <span className={`ml-2 px-2 py-1 rounded-full text-xs font-bold animate-bounce-subtle ${
                    ...
                    <>
                      ...
                      {suggestedUsers.length > 0 && (
                        <span className={`px-2 py-1 rounded-full text-xs font-bold ${
                          activeTab === 'suggestions' ? 'bg-white/20' : 'bg-purple-500 text-white'
                        }`}>
                            ...
                            {user.friendRequestReceived ? (
                              ...
                              <button
                                ...
                                className={`w-full px-4 py-3 rounded-lg font-medium transition-all duration-200 flex items-center justify-center gap-2 ${
                                  user.friendRequestPending === "Pending"
                      ...
                      <div className="p-6">
                        ...
                        {sugg.friendRequestReceived ? (
                          ...
                          <button
                            ...
                            className={`w-full px-4 py-3 rounded-lg font-medium transition-all duration-200 flex items-center justify-center gap-2 ${
                              sugg.friendRequestPending === "Pending"
                                ? `${darkMode ? 'bg-gray-700 text-gray-400' : 'bg-slate-100 text-slate-500'} cursor-not-allowed`
                                : 'bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white shadow-lg hover:shadow-xl hover:scale-105'
                            }`}
